...
{\textbf{No.} & \textbf{Name} & \textbf{Description} & \textbf{Example Value}}
{
    ...
    2 & Definition & The content for the conjecture. & Someone's Conjecture states...
}
...
\comment{Add theorem, lemma, proposition, and standard problem here.}

\subsubsection{Sub-Environments}

\comment{Add proof and solution here.}
