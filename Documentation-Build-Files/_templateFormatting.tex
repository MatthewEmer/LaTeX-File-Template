...
\newcommand{\templateversion}{4.1.2}

\hypersetup{colorlinks=true, urlcolor=violet, linkcolor=darkgray} % Formatting URLs and links.
...
\newcommand{\innerjoin}{\mathbin{\bowtie\mkern-5.8mu}\;}
