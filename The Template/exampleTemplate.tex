...
You can easily use the basic maths number sets \(\N, \,\Z, \,\Q, \,\R, \,\I, \,\C\) by typing \(\backslash[letter]\) and the join symbols \(\insertinnerjoin \; \insertleftouterjoin \; \insertrightouterjoin \; \insertfullouterjoin\) by typing \(\backslash[join type]\) as well as calculus notation such as \(\hessian{f},\;\jacobian{f},\;\lagrange\) by typing \(\backslash[notation]\). You can also use \(\dotproduct{u+v}{w}\) by typing \(\backslash dotproduct\{[vector1]\}\{[vector2]\}\).
...
\begin{itemize}
    ...
    \item \proposition{0.0.1}{Proposition here.}{Proof here.}
    
    \item \standardproblem{0.0.1}{Question here.}{Solution here.}
\end{itemize}
