...
You can easily use the basic maths number sets \(\N, \,\Z, \,\Q, \,\R, \,\I, \,\C\) by typing \(\backslash[letter]\) and the join symbols \(\insertinnerjoin \; \insertleftouterjoin \; \insertrightouterjoin \; \insertfullouterjoin\) by typing \(\backslash[join type]\).
